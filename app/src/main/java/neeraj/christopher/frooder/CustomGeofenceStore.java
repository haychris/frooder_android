...
import static neeraj.christopher.frooder.Constants.INVALID_FLOAT_VALUE;
import static neeraj.christopher.frooder.Constants.INVALID_INT_VALUE;
import static neeraj.christopher.frooder.Constants.INVALID_LONG_VALUE;
import static neeraj.christopher.frooder.Constants.KEY_EXPIRATION_DURATION;
import static neeraj.christopher.frooder.Constants.KEY_LATITUDE;
import static neeraj.christopher.frooder.Constants.KEY_LONGITUDE;
import static neeraj.christopher.frooder.Constants.KEY_PREFIX;
import static neeraj.christopher.frooder.Constants.KEY_RADIUS;
import static neeraj.christopher.frooder.Constants.KEY_TRANSITION_TYPE;
 ...
 */
public class CustomGeofenceStore {
     ...
     */
    public CustomGeofenceStore(Context context) {
     ...
     */
    public CustomGeofence getGeofence(String id) {
        ...
        if (lat != INVALID_FLOAT_VALUE
            ...
            return new CustomGeofence(id, lat, lng, radius, expirationDuration, transitionType);
        }
     ...
     */
    public void setGeofence(String id, CustomGeofence geofence) {
